...
export default function Home() {
  const [activeButton, setActiveButton] = useState<"listar" | "crear" | "editar" | null>(null);
        ...
        <div className="relative mb-6">
          <div className="flex justify-between items-center relative z-10">
            ...
            <div className="flex items-center gap-3 relative">
              <Link to="/locations" onClick={() => handleButtonClick("listar")}
              ...
              <Link to="/locations/create" onClick={() => handleButtonClick("crear")}
              ...
              <Link to="/locations/edit" onClick={() => handleButtonClick("editar")}
                className={`px-4 py-2 transition-colors z-10 cursor-pointer ${
                  activeButton === "editar"
                    ? "border border-gray-300 bg-transparent text-[#7BA2D4] rounded-t-md"
                    : "text-[#163C65]"
