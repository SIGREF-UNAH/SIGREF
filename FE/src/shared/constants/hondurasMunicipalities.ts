/** Municipios oficiales por departamento (Honduras). */
export const HONDURAS_MUNICIPALITIES: Record<string, string[]> = {
  Atlantida: [
    "La Ceiba",
    "El Porvenir",
    "Tela",
  ...
  "Islas de la Bahia": ["Roatán", "Guanaja", "José Santos Guardiola", "Utila"],
  "La Paz": [
    "La Paz",
    "Aguanqueterique",
    "Cabañas",
