...
public class ReportHistoryEntity : BaseEntity
{
    ...
    /// </remarks>
    /// <seealso
    ///     href="https://github.com/HangfireIO/Hangfire/blob/333bd8eb228402abcee3f261cf32412e844f32c0/src/Hangfire.SqlServer/Install.sql#L82-L89">
    ...
    /// <summary>
    ///     Copia literal (JSON) de los datos del hospital al momento del reporte (Director, Logo, etc.). Evita cambios
    ///     históricos.
    /// </summary>
