...
public abstract class BaseFhirSearchParameterInitializer
{
    ...
    ///         <description><see langword="true"/> si se creó exitosamente al menos un SearchParameter; de lo contrario, <see langword="false"/>.</description>
    ///     </item>
    ///     <item>
    ///         <term><c>ResourceType</c></term>
    ///         <description>El nombre del tipo de recurso procesado (por ejemplo, "Patient") o "Unknown" si no se encontraron definiciones.</description>
    ///     </item>
    /// </list>
    /// </returns>
    ...
    ///         <description>Resuelve y valida la sintaxis de la expresión FHIRPath mediante <see cref="SearchParameterDefinition.ResolveExpression"/>.</description>
    ///     </item>
    ///     <item>
    ///         <term>Verificación de Existencia:</term>
    ///         <description>Consulta el servidor FHIR buscando coincidencias por <c>code</c> y <c>base</c> para evitar duplicados.</description>
    ///     </item>
    ///     <item>
    ///         <term>Persistencia:</term>
    ///         <description>Si el recurso no existe, se instancia un nuevo <see cref="SearchParameter"/> con estado <c>Active</c> y se registra en el servidor.</description>
    ///     </item>
    /// </list>
    /// </remarks>
    /// <param name="definition">Objeto de transferencia de datos que contiene las especificaciones técnicas del parámetro de búsqueda.</param>
    /// <returns>
    /// Un <see cref="EnsureResult"/> que categoriza el desenlace de la operación:
    /// <list type="bullet">
    ///     <item><term><see cref="EnsureResult.Created"/></term><description>El recurso fue registrado exitosamente en el servidor.</description></item>
    ///     <item><term><see cref="EnsureResult.AlreadyExists"/></term><description>Se omitió la creación porque ya existe un parámetro idéntico.</description></item>
    ///     <item><term><see cref="EnsureResult.Failed"/></term><description>La operación falló. Consulte los logs para distinguir entre errores de configuración, red o rechazo del servidor FHIR.</description></item>
    /// </list>
    /// </returns>
    ...
    /// <exception cref="FhirOperationException">Capturada internamente si el servidor FHIR rechaza la transacción (ej. Error 400 o 403).</exception>
