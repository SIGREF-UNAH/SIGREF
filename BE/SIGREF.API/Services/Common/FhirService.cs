...
public class FhirService
{
    ...
    /// Configura el cliente FHIR utilizando los par�metros definidos en el entorno.
    /// </summary>
    /// <param name="env">
    /// Opciones de entorno que contienen la configuraci�n del endpoint FHIR.
    ...
    public FhirService(IOptions<Env> env)
    {
        ...
        _fhirClient = new FhirClient(fhirEndpoint.HAPIFHIR_HTTP +"/fhir", new FhirClientSettings()
