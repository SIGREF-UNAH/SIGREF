...
///         <list type="bullet">
///             <item>
///                 <description>Creación idempotente de recursos <see cref="CodeSystem" /> y <see cref="ValueSet" />.</description>
///             </item>
///             <item>
///                 <description>
///                     Verificación de existencia de recursos con un mecanismo integrado de tolerancia a fallos
///                     (reintentos y backoff progresivo).
///                 </description>
///             </item>
///             <item>
///                 <description>
///                     Actualización incremental para añadir conceptos nuevos a catálogos ya desplegados sin
///                     destruir o alterar datos existentes.
///                 </description>
///             </item>
///         </list>
///     </para>
...
///         3. Si el catálogo permite adiciones en caliente, implementa la interfaz <c>IUpdatableTerminologySeeder</c>.
///         <br />
///         4. Registra el servicio en el contenedor de dependencias usando
///         <c>services.AddTerminologySeeder&lt;TuSeeder&gt;()</c>.
///     </para>
/// </remarks>
public abstract class TerminologySeederBase : ITerminologySeeder
{
    ...
    ///     Se lanza si <paramref name="fhirService" /> o <paramref name="logger" /> son
    ///     <c>null</c>.
    /// </exception>
    protected TerminologySeederBase(FhirService fhirService, ILogger logger)
    {
        ...
        FhirClient = fhirService.GetFhirClient() ??
                     throw new InvalidOperationException("No se pudo obtener una instancia valida de FhirClient.");
    ...
    /// </summary>
    /// <value>
    ///     Una cadena que representa el nombre del catálogo, utilizado principalmente en la salida de logs para facilitar
    ///     la trazabilidad.
    /// </value>
    /// <inheritdoc />
    ...
    /// <summary>
    ///     Asegura la existencia de un <see cref="ValueSet" /> en el servidor FHIR. Si no existe, lo crea vinculado a su
    ///     CodeSystem.
    /// </summary>
    ...
    private async Task UpdateCodeSystemAsync(TerminologyDefinition def, CancellationToken ct)
    {
        ...
        await FhirClient.UpdateAsync(existing, false, ct);
    ...
    /// <summary>
    ///     Asegura que las referencias dentro del <see cref="ValueSet" /> estén al día con los códigos más recientes del
    ///     sistema de códigos.
    /// </summary>
    /// <param name="def">Definición con la lista de conceptos esperados.</param>
    /// <param name="ct">Token de cancelación.</param>
    ...
    ///     Etiqueta descriptiva del recurso consultado, utilizada estrictamente para trazabilidad en
    ///     logs.
    /// </param>
    /// <param name="ct">Token de cancelación.</param>
    /// <returns>
    ///     Retorna <c>true</c> si el bundle contiene entradas (entry); en caso de agotar los intentos, asume <c>false</c>
    ///     .
    /// </returns>
