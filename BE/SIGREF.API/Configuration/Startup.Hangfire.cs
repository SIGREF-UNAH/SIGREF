...
public partial class Startup
{
    private void AddHangfire(IServiceCollection services)
    {
        ...
        var isEmbedded = _configuration.GetValue("Hangfire:IsEmbedded", true);
        ...
        if (isEmbedded)
            services.AddHangfireServer(opt =>
            {
                ...
                var calculatedWorkers = Environment.ProcessorCount * 2;
    ...
    private void UseHangfireDashboard(IApplicationBuilder app)
    {
        ...
        var dashboardEnabled = _configuration.GetValue("Hangfire:EnableDashboard", true);
