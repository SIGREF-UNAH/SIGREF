...
public static class OrganizationExtensions
{
    public static OrganizationDto ToDto(this Organization organization)
    {
        var dto = new OrganizationDto
        {
            ...
            LastUpdated = organization.Meta?.LastUpdated?.UtcDateTime
        ...
        // Aliases
        if (organization.Alias != null) dto.Alias = organization.Alias.ToList();
    ...
    public static Organization ToFhirResource(this CreateOrganizationDto dto)
    {
        ...
        // Aliases
        if (dto.Alias != null && dto.Alias.Any()) organization.Alias = dto.Alias;
    ...
    {
        if (dto.Active.HasValue) existingOrganization.Active = dto.Active.Value;

        if (!string.IsNullOrEmpty(dto.Name)) existingOrganization.Name = dto.Name;
        ...
        if (dto.Alias != null) existingOrganization.Alias = dto.Alias;
        ...
        if (existingOrganization.Meta == null) existingOrganization.Meta = new Meta();
